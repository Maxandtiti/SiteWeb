...
public class MyEvents {
	...
	public MyEvents(Integer idmyevents, Integer idusers, String slug, String title, String description,
	...
	@Column(name = "idusers", length = 45, nullable = false)
	...
	public String toString() {
		return "MyEvents [idmyevents=" + idmyevents + ", idusers=" + idusers + ", slug=" + slug + ", title=" + title
				...
				+ ", image=" + image + ", preview=" + preview + ", source_image=" + source_image + ", times=" + times
				...
				+ ", accessibility=" + accessibility + ", adress=" + adress + ", city=" + city + ", zipcode=" + zipcode
				+ ", department=" + department + ", phone_number=" + phone_number + ", email=" + email + ", conditions="
				+ conditions + "]";
	}
